...
🔗 **Live Demo**: [https://daffarch.github.io/portfolio](https://daffarch.github.io/portfolio)
...
```bash
git clone https://github.com/daffarch/portfolio.git my-portfolio
cd my-portfolio
npm install
npm run dev
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/daffarch/portfolio)

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/daffarch/portfolio)
...
```bash
git clone https://github.com/daffarch/portfolio.git
cd portfolio
```
...
- GitHub: [@daffarch](https://github.com/daffarch)
- Email: daffarch@gmail.com

## 🤝 Contributing

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/daffarch/portfolio/issues).
