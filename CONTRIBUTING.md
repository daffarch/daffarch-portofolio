...
This project and everyone participating in it is governed by our [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [daffarch@gmail.com](mailto:daffarch@gmail.com).

## How Can I Contribute?

### 🐛 Reporting Bugs

Before creating bug reports, please check the [existing issues](https://github.com/daffarch/portfolio/issues) to avoid duplicates.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/daffarch/portfolio/issues).
...
```bash
git remote add upstream https://github.com/daffarch/portfolio.git
```
...
- 🔍 Search [existing issues](https://github.com/daffarch/portfolio/issues)
- 💬 Ask questions in [Discussions](https://github.com/daffarch/portfolio/discussions)
- 📧 Email: [daffarch@gmail.com](mailto:daffarch@gmail.com)
